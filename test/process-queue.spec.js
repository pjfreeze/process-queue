...
describe('ProcessQueue#append', () => {
  it('should add the items to the end', () => {
    ...
    assert(processQueue._unprocessed.length === (items.length + toAppend.length));
    const lastInQueue = processQueue._unprocessed[processQueue._unprocessed.length - 1];
...
describe('ProcessQueue#prepend', () => {
  it('should add the items to the beginning', () => {
    ...
    assert(processQueue._unprocessed.length === (items.length + toPrepend.length));
    const firstInQueue = processQueue._unprocessed[0];
